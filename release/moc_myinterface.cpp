...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MyInterface_t, stringdata) + ofs \
...
const QMetaObject MyInterface::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MyInterface.data,
      qt_meta_data_MyInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyInterface.stringdata))
        return static_cast<void*>(const_cast< MyInterface*>(this));
